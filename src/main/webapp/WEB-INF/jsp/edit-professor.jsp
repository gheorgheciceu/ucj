...
<div class="container">
	...
	<form:form class="cd-form" modelAttribute="professor" method="post">

		<h4 class="formTitle">MODIFICARE INSTRUCTOR</h4>
		...
		<p class="fieldset">
			...
			<form:input path="lastName" class="full-width has-padding has-border"
				...
				placeholder="Prenumele instructorului" />
			<span class="cd-error-message">Error message here!</span>
		</p>
		...
		<p class="fieldset">
			...
			<form:input path="email" class="full-width has-padding has-border"
				...
				placeholder="Adresa de e-mail a instructorului" />
			<span class="cd-error-message">Error message here!</span>
		</p>
		...
		<p class="fieldset">
			...
			<form:input path="phone" class="full-width has-padding has-border"
				id="signin-email" type="text"
				placeholder="Numarul de telefon al instructorului" />
			<span class="cd-error-message">Error message here!</span>
		</p>
		...
		<h5>CATEGORII:</h5>
		<c:forEach items="${professor.categories}" var="category">
			<div class="checkbox">
				<label> <input type="checkbox" checked="checked"
					name="categories" value="${category.id}"> <span
					class="checkFont">${category.type.type}</span>
				</label>
			</div>
		</c:forEach>

		<c:forEach items="${categoryType}" var="category">
			<div class="checkbox">
				<label> <input type="checkbox" 
					name="categories" value="${category.id}"> <span
					class="checkFont">${category.type}</span>
				</label>
			</div>
		</c:forEach>
		...
		<%-- <c:forEach items="${professor.categories}" var="category"
			...
			<div class="checkbox">
				<label> <input type="checkbox" checked="checked"
					name="categories" value="${category.id}"> <span
					class="checkFont">${category.categoryName}</span>
				</label>
			</div>
		</c:forEach>
 --%>
		...
		<p class="fieldset">
			<input class="full-width" type="submit" value="MODIFICA">
		</p>
	</form:form>
</div>

...
<div class="container">
	...
	<form:form class="cd-form" modelAttribute="studentType" method="post">

		<h4 class="formTitle">MODIFICARE STUDENT</h4>
...
<!-- 
 ...
 -->
		...
		<p class="fieldset">
			<input class="full-width" type="submit" value="MODIFICARE">
		</p>
	</form:form>
</div>

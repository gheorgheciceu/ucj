			...
			<div class="container">
				...
				<div class="row">
					<div class="text-center filters col-sm-12">
							...
							<li><a class="selected" href="/timetable">Vizualizare
									orar</a></li>
							<c:forEach items="${categories}" var="category">
							
								<c:choose>
									<c:when test="${category.id == selectedCategory}">
										<li><a href="redirect:/timetable/${category.id}" class="selected" >Categoria:
												${category.type.type}</a></li>
									</c:when>
									<c:otherwise>
										<li><a href="timetable/${category.id}" class="">Categoria:
												${category.type.type}</a></li>
									</c:otherwise>
								</c:choose>
						...
						<div class="table-responsive">
							<table class="table table-striped table-bordered" id="timetable">
								<thead>
									<tr>
										<th></th>
										<th><a href="occupy-day/0"> ${timetables[0][0]}</a></th>
										<th><a href="occupy-day/1">${timetables[0][1]}</a></th>
										<th><a href="occupy-day/2">${timetables[0][2]}</a></th>
										<th><a href="occupy-day/3">${timetables[0][3]}</a></th>
										<th><a href="occupy-day/4">${timetables[0][4]}</a></th>
										<th><a href="occupy-day/5">${timetables[0][5]}</a></th>
										<th><a href="occupy-day/6">${timetables[0][6]}</a></th>
									</tr>
								</thead>
								<tbody>
									<tr>
										<th><a href="occupy-hour/0">8:00 - 10:00</a></th>

										<c:choose>
											<c:when test="${empty timetables[1][0]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/1/0"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
													href="<spring:url value="deactivate-appointment/${selectedCategory}/1/0"/>">${timetables[1][0]}</a></td>
											</c:otherwise>
										</c:choose>
										<c:choose>
											<c:when test="${empty timetables[1][1]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/1/1"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
													href="<spring:url value="deactivate-appointment/${selectedCategory}/1/1"/>">${timetables[1][1]}</a></td>
											</c:otherwise>
										</c:choose>
										<c:choose>
											<c:when test="${empty timetables[1][2]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/1/2"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
													href="<spring:url value="deactivate-appointment/${selectedCategory}/1/2"/>">${timetables[1][2]}</a></td>
											</c:otherwise>
										</c:choose>
										<c:choose>
											<c:when test="${empty timetables[1][3]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/1/3"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
													href="<spring:url value="deactivate-appointment/${selectedCategory}/1/3"/>">${timetables[1][3]}</a></td>
											</c:otherwise>
										</c:choose>
										<c:choose>
											<c:when test="${empty timetables[1][4]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/1/4"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
													href="<spring:url value="deactivate-appointment/${selectedCategory}/1/4"/>">${timetables[1][4]}</a></td>
											</c:otherwise>
										</c:choose>
										<c:choose>
											<c:when test="${empty timetables[1][5]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/1/5"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
													href="<spring:url value="deactivate-appointment/${selectedCategory}/1/5"/>">${timetables[1][5]}</a></td>
											</c:otherwise>
										</c:choose>
										<c:choose>
											<c:when test="${empty timetables[1][6]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/1/6"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
													href="<spring:url value="deactivate-appointment/${selectedCategory}/1/6"/>">${timetables[1][6]}</a></td>
											</c:otherwise>
										</c:choose>
									</tr>

									<tr>
										<th><a href="occupy-hour/1">10:00 - 12:00</a></th>
										...
										<c:choose>
											<c:when test="${empty timetables[2][0]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/2/0"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
										...
										<c:choose>
											<c:when test="${empty timetables[2][1]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/2/1"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
										...
										<c:choose>
											<c:when test="${empty timetables[2][2]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/2/2"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
										...
										<c:choose>
											<c:when test="${empty timetables[2][3]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/2/3"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
										...
										<c:choose>
											<c:when test="${empty timetables[2][4]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/2/4"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
										...
										<c:choose>
											<c:when test="${empty timetables[2][5]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/2/5"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
										...
										<c:choose>
											<c:when test="${empty timetables[2][6]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/2/6"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
									...
									<tr>
										<th><a href="occupy-hour/2">12:00 - 14:00</a></th>
										...
										<c:choose>
											<c:when test="${empty timetables[3][0]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/3/0"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
										...
										<c:choose>
											<c:when test="${empty timetables[3][1]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/3/1"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
										...
										<c:choose>
											<c:when test="${empty timetables[3][2]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/3/2"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
										...
										<c:choose>
											<c:when test="${empty timetables[3][3]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/3/3"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
										...
										<c:choose>
											<c:when test="${empty timetables[3][4]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/3/4"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
										...
										<c:choose>
											<c:when test="${empty timetables[3][5]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/3/5"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
										...
										<c:choose>
											<c:when test="${empty timetables[3][6]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/3/6"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
									...
									<tr>
										<th><a href="occupy-hour/3">14:00 - 16:00</a></th>
										...
										<c:choose>
											<c:when test="${empty timetables[4][0]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/4/0"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
										...
										<c:choose>
											<c:when test="${empty timetables[4][1]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/4/1"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
										...
										<c:choose>
											<c:when test="${empty timetables[4][2]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/4/2"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
										...
										<c:choose>
											<c:when test="${empty timetables[4][3]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/4/3"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
										...
										<c:choose>
											<c:when test="${empty timetables[4][4]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/4/4"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
										...
										<c:choose>
											<c:when test="${empty timetables[4][5]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/4/5"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
										...
										<c:choose>
											<c:when test="${empty timetables[4][6]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/4/6"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
									...
									<tr>
										<th><a href="occupy-hour/4">16:00 - 18:00</a></th>
										...
										<c:choose>
											<c:when test="${empty timetables[5][0]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/5/0"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
										...
										<c:choose>
											<c:when test="${empty timetables[5][1]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/5/1"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
										...
										<c:choose>
											<c:when test="${empty timetables[5][2]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/5/2"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
										...
										<c:choose>
											<c:when test="${empty timetables[5][3]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/5/3"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
										...
										<c:choose>
											<c:when test="${empty timetables[5][4]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/5/4"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
										...
										<c:choose>
											<c:when test="${empty timetables[5][5]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/5/5"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
										...
										<c:choose>
											<c:when test="${empty timetables[5][6]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/5/6"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
									...
									<tr>
										<th><a href="occupy-hour/5">18:00 - 20:00</a></th>
										...
										<c:choose>
											<c:when test="${empty timetables[6][0]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/6/0"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
										...
										<c:choose>
											<c:when test="${empty timetables[6][1]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/6/1"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
										...
										<c:choose>
											<c:when test="${empty timetables[6][2]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/6/2"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
										...
										<c:choose>
											<c:when test="${empty timetables[6][3]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/6/3"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
										...
										<c:choose>
											<c:when test="${empty timetables[6][4]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/6/4"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
										...
										<c:choose>
											<c:when test="${empty timetables[6][5]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/6/5"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
										...
										<c:choose>
											<c:when test="${empty timetables[6][6]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/6/6"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
									...
									<tr>
										<th><a href="occupy-hour/6">20:00 - 22:00</a></th>
										...
										<c:choose>
											<c:when test="${empty timetables[7][0]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/7/0"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
										...
										<c:choose>
											<c:when test="${empty timetables[7][1]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/7/1"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
										...
										<c:choose>
											<c:when test="${empty timetables[7][2]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/7/2"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
										...
										<c:choose>
											<c:when test="${empty timetables[7][3]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/7/3"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
										...
										<c:choose>
											<c:when test="${empty timetables[7][4]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/7/4"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
										...
										<c:choose>
											<c:when test="${empty timetables[7][5]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/7/5"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
										...
										<c:choose>
											<c:when test="${empty timetables[7][6]}">
												<td><a class=""
													href="<spring:url value="occupy/${selectedCategory}/7/6"/>">Programare</a>
											</c:when>
											<c:otherwise>
												<td><a class=""
